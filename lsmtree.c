...
/* Initializer */
int lsmTree_init(lsmTree ** treeRef, int input_max_c0_size, int input_num_blocks_per_level, int input_max_level_in_ram){
...
/* Update the empty_ram_block and empty_ram_level of the tree */
int update_empty_level_block(lsmTree * tree){
